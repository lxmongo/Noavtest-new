    ...
    public sealed partial class RunCalibratePage : Page
    {
        ...
        private async void savePdf()
        {
            ...
            using (PdfDocument document = new PdfDocument())
            {
                ...
                document.Pages[0].Graphics.DrawString(string.Format("{0}: {1}", loader.GetString("PressurePDF1"), SetPressure.ToString()), font2, PdfBrushes.Black, rf6);
               ...
               // Sfmenu.Visibility = Visibility.Visible;
                ...
                PointF pfp4 = new PointF(page.Graphics.ClientSize.Width, 595);
                ...
                //Basic_Chart.Width = 640;
                //TopChartGrid.Width = 650;
                Basic_Chart.Behaviors.Add(zoomBehavior);
                notifyPopup.Show();
            }
            //updateVOC();
        ...
        private void GenerateTableAgain_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (MethodNameText == "BTEX")
            {
                ...
                for (int i = 0; i < testInfoList.Count; i++)
                {
                    Debug.WriteLine("this is the test test infolist: " + testInfoList[i].ID);
                }
                //update VOC
                //updateVOC();
                showVOC();
